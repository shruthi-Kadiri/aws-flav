  ...
  <div class="intro">
    <div class="overlay">
      <div class="container">
		...
		<form action="calculate1.jsp" method="post" >

<tr><th style="color:white;font-size:20px;"><br>Recipe Name</th><th><br><input type="text" name="name" value=<%= request.getParameter("name") %>  style="color:black;"/></th></tr>
