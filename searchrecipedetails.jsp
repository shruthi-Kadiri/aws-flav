  ...
  <div class="intro">
    <div class="overlay">
      <div class="container">
		...
		<form action="searchrecipedetails1.jsp" method="post" >
<tr><tH style="color:white;font-size:20px;">Enter RecipeName</th><th><input type="text" name="recipe" required style="color:black;"/><br></th></tr>
