...
<tr><th style="color:white;">EmailId</th><th><input type="email" name="email" value="<%= rs.getString(3) %>" required /></th></tr>

<tr><th style="color:white;">MobileNumber</th><th><input type="text" name="mobile" value="<%= rs.getString(4	) %>" required /></th></tr>
