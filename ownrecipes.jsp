...
<tr><Th>Name<th>Ingrdients</th>><th>Making</th><th>Type</th><th>Category</th><th>Favorite Food</th><th>UserName</th><th>operation</th></tr>
...
<th><a href="addrating.jsp?name=<%= rs.getString(1) %> ">Add Rating</a>/<a href="viewrating.jsp?name=<%= rs.getString(1) %> ">view Rating</a>/ </th>
  </tr>
<%}
%>
