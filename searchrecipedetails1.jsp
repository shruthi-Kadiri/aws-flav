      ...
      <div class="container">
        <div class="row">
          <div class="intro-text">
                     <table border=2 style="font-size:18px;color:white;" align="center" width=100%>
<tr><td colspan=7 align="center">Recipe Details</td></tr>
<tr><Th>Name<th>Ingrdients</th>><th>Making</th><th>Type</th><th>Category</th><th>Rating</th></tr>
...
while(rs.next())
{
	...
	PreparedStatement p=con.prepareStatement("select * from ratings where recipename=?");
	p.setString(1,name1);
	ResultSet r=p.executeQuery();
	r.next();
	String rat=r.getString(2);
	%>
  <tr>
