...
<li><a href="searchrecipedetails.jsp" class="page-scroll">Search Recipe</a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="intro-text">
            	<h1 style="font-size:40px;font-style:arial;">Search Recipe</h1>
			<table align="center" width=40% style="font-size:20px;">
		<form action="addrating1.jsp" method="post" >
<tr><tH style="color:white;font-size:20px;"> Recipe Name</th><th><input type="text" name="recipe" value="<%= request.getParameter("name") %>" required style="color:black;"/><br></th></tr>

<tr><tH style="color:white;font-size:20px;">Rating </th><th><input type="number" name="rating" min=1 max=5  required style="color:black;"/><br></th></tr>
