...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
 ...
 <li><a href="approveusers.jsp" class="page-scroll">Approve Users</a></li>
      <li><a href="uploadrecipedetails.jsp" class="page-scroll">Upload Recipe Details</a></li>
		 <li><a href="adminfeedback.jsp" class="page-scroll">View User Created Recipe</a></li>
...
<tr><td colspan=7 align="center">User Details</td></tr>
<tr><Th>Name<th>EmailId</th><th>Contact Number</th><th>Address</th><th>Operation</th></tr>
<%@include file="DBConn.jsp" %>
<%
PreparedStatement pst=con.prepareStatement("select * from userdetails where status=0");
...
{%>
  ...
  <th>
  <a href="acceptuser.jsp?uid=<%= rs.getString(1) %>">Accept/</a>
  <a href="rejectuser.jsp?uid=<%= rs.getString(1) %>">Reject</a>
